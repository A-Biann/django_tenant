...
class Settings(models.Model):
    ...
    sitename = models.CharField('系統名稱', max_length=100, default='', null=True, blank=True)
    email = models.CharField('郵件', max_length=100, default='', null=True, blank=True)
    logo = models.FileField('logo圖片', null=True, blank=True, upload_to=helpers.upload_handle)
    favicon = models.FileField('favicon圖片', null=True, blank=True, upload_to=helpers.upload_handle)
    style = models.FileField('CSS style', null=True, blank=True, upload_to=helpers.upload_handle)
